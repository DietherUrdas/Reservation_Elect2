...
document.getElementById('reservationForm').addEventListener('submit', function(e) {
    ...
    const billInfo = calculateTotalBill(
        data.roomType,
        data.roomCapacity,
        data.paymentType,
        data.fromMonth,
    ...
    // Add bill information to data
    data.totalNights = billInfo.totalNights;
    data.pricePerNight = billInfo.pricePerNight;
    data.baseTotalBill = billInfo.baseTotalBill;
    data.discount = billInfo.discount;
    data.discountPercent = billInfo.discountPercent;
    data.additionalCharge = billInfo.additionalCharge;
    data.totalBill = billInfo.totalBill;
